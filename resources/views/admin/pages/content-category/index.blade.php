...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> Content category </h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        <button type="button" class="btn btn-block btn-primary add_form" data-title="content category"
                            data-action="{{ url('/admin/category/') }}">Add content category</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-checkable" id="content-cat-show">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Image</th>
                            ...
                            <button type="submit" class="btn btn-danger" id="multiple_delete_btn"
                                data-title="content category" disabled>
                                Delete selected
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control " name="logo"
                                    onchange="load_preview_image(this);" style="height:auto;"
...
@endsection
@push('page_scripts')
    <script src="{{ asset('public/admin/page/content-category.js') }}"></script>
@endpush
