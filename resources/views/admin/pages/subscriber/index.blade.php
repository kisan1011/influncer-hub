                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-checkable" id="subscriber-show">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Email</th>
                            ...
                            <button type="submit" class="btn btn-danger" id="multiple_delete_btn" data-title="subscriber"
                                disabled>
                                Delete selected
...
@endsection
@push('page_scripts')
    <script src="{{ asset('public/admin/page/subscriber.js') }}"></script>
@endpush
