...
class ContentCategory extends Model
{
    ...
    {
      return $this->belongsTo(Channel::class, 'id', 'content_cat_id'); // remove content_cat_id from Channel table
    }

    // Channel Content Category relation
    public function channelContentCategory() {
      return $this->hasMany(ChannelContentCategory::class, 'content_cat_id', 'id');
    }
}
