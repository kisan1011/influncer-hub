...
class HstsMiddleware
{
    ...
    public function handle(Request $request, Closure $next)
    {
     ...
     // Set the X-Frame-Options header
      ...
      // $cspHeader = "default-src 'none'; script-src 'self' 'nonce-$nonce'; connect-src 'self'; img-src 'self'; style-src 'self';";
      // $cspHeader = "default-src 'none'; script-src 'self' 'nonce-$nonce'; connect-src 'self'; img-src 'self'; style-src 'self'; frame-ancestors 'none';";
      $cspHeader = "Content-Security-Policy: default-src 'none';";
